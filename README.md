...
- El proxy prioriza la API oficial de ExchangeMonitor cuando existen credenciales, luego intenta la página pública y finalmente una lectura alternativa del mismo contenido.
...
Mientras no haya credenciales, el proxy intenta la página pública y una ruta de lectura alternativa. Si ambas son bloqueadas o alcanzan su límite, el dashboard conserva el respaldo de DolarApi para que las cotizaciones oficiales sigan visibles.
